                    ...
                    <div class="card-header">{{ __('Cart') }}
                        <div class="card-body">
                            ...
                            <div class="card-group m-auto">
                                ...
                                <div class="card m-3" style="widht: 14rem;">
                                    <img src=" {{url('storage/' . $cart->product->image)}} " class="card-img-top" alt="">
                                    <div class="card-body">
                                        ...
                                        <form action=" {{ route('update_cart', $cart) }} " method="post">
                                            ...
                                            <div class="input-group mb-3">
                                                <input class="form-control" type='number' name="amount" value="{{$cart->amount}}">
